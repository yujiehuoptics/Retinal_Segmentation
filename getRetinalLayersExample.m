...
%     end
    imagePath{1} = 'E:\oct\phasecode\segmentation\pangyuteng-caserel-bb0865d\pangyuteng-caserel-bb0865d\201051-0.oct120.tiff'; %exampleOCTimage0001
    
%       imagePath{1} = 'E:\oct\phasecode\segmentation\pangyuteng-caserel-bb0865d\pangyuteng-caserel-bb0865d\aaa.tif'; 
%      imagePath{1} = 'E:\oct\phasecode\segmentation\pangyuteng-caserel-bb0865d\pangyuteng-caserel-bb0865d\cq3_Bscan-33_pass.tif';
%       imagePath{1} = 'E:\oct\phasecode\segmentation\pangyuteng-caserel-bb0865d\pangyuteng-caserel-bb0865d\1-1.oct260.tiff';
    
    figure;
    title('pick a region of interest to segment for the selected images');     %选择想要分层的区域
...
for i = 1:numel(imagePath)
    ...
    img2 = double(img);
    img3= filter2(fspecial('average',3),img2);
    zhongzhi= median(img3);
    zhongzhi2= median(zhongzhi);
    
    for mi=1:1:512
        for mj=1:1:600
            if img3(mi,mj)<zhongzhi2
            img3(mi,mj)=0;
            end
        end
    end
    ...
    %segment whole image if yrange/xrange is not specified.   %如果x和y不明确
    ...
    % get retinal layers.
    [retinalLayers, params] = getRetinalLayers(img);    %分层
