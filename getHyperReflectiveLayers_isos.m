function pathsf = getHyperReflectiveLayers_isos(inputImg,constants)
...
img = demo(inputImg,20,100,0.01);     %双边带滤波
...
% imgSmo = imfilter(imgSmo,fspecial('gaussian',params.filterParams(1:2),params.filterParams(3)),'replicate');
% imgSmo = imfilter(imgSmo,fspecial('gaussian',params.filterParams(1:2),params.filterParams(3)),'replicate');
inputImg = imfilter(imgSmo,fspecial('gaussian',params.filterParams(1:2),params.filterParams(3)),'replicate');
